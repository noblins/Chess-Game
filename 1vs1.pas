...
procedure TForm1.PartieClick(Sender: TObject);
begin
piece_en_main := A_Partie ;
end;

procedure TForm1.Pnl_NavigClick(Sender: TObject);
begin
panel1.Visible :=  not panel1.Visible ;
end;

procedure TForm1.RB_CavalierClick(Sender: TObject);
begin
...
procedure TForm1.RB_DameClick(Sender: TObject);
begin
 piece_en_main := A_dame;
 Lbl_Piece.Caption:= 'dame';
end;

procedure TForm1.RB_FouClick(Sender: TObject);
begin
piece_en_main := A_fou;
 Lbl_Piece.Caption:= 'fou';
end;

procedure TForm1.RB_Pion_BlancClick(Sender: TObject);
begin
...
procedure TForm1.RB_Pion_NClick(Sender: TObject);
begin
piece_en_main := A_pion;
...
procedure TForm1.RB_RoiClick(Sender: TObject);
begin
piece_en_main := A_roi;
 Lbl_Piece.Caption:= 'roi';
end;

procedure TForm1.RB_TextureBoisClick(Sender: TObject);
begin
...
procedure TForm1.RB_TextureMarbreClick(Sender: TObject);
begin
...
procedure TForm1.RB_TourClick(Sender: TObject);
begin
piece_en_main := A_tour ;
 Lbl_Piece.Caption:= 'tour';
end;

procedure TForm1.RB_zeroClick(Sender: TObject);
begin
piece_en_main := A_zero ;
 Lbl_Piece.Caption:= 'vide';
end;

procedure TForm1.SBt_SEClick(Sender: TObject);
begin
 Oeil_ez := Oeil_ez  + 1 ;
 FormResize(Sender);
end;

procedure TForm1.SBt_SOClick(Sender: TObject);
begin
Oeil_ez := Oeil_ez  - 1 ;
FormResize(Sender);
end;

procedure TForm1.SBt_SudClick(Sender: TObject);
begin
Oeil_ex := Oeil_ex  - 1 ;
...
procedure TForm1.SBt_SudMouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
...
procedure TForm1.testpClick(Sender: TObject);
begin
piece_en_main := A_partie ;
init_plateau ;
end;

procedure TForm1.SBt_EstClick(Sender: TObject);
begin
 Oeil_ey := Oeil_ey  + 1 ;
 FormResize(Sender);
end;

procedure TForm1.SBt_OuestClick(Sender: TObject);
begin
Oeil_ey := Oeil_ey  - 1 ;
FormResize(Sender);
end;

procedure TForm1.SBt_NOClick(Sender: TObject);
begin
 Oeil_ez := Oeil_ez  + 1 ;
 FormResize(Sender);
end;

procedure TForm1.SBt_NordClick(Sender: TObject);
begin
 Oeil_ez := Oeil_ez  + 1 ;
 FormResize(Sender);
end;

procedure TForm1.SBt_NordMouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
 Oeil_ex := Oeil_ex  + 1 ;
 FormResize(Sender);
...
procedure TForm1.BNtn_HorizonClick(Sender: TObject);
begin
horizon := not horizon;
end;
...
procedure TForm1.Btn_TextureClick(Sender: TObject);
begin
...
procedure TForm1.Btn_OrionClick(Sender: TObject);
var temp : glUint;
begin
...
procedure TForm1.Btn_PiecesClick(Sender: TObject);
begin
...
procedure TForm1.Btn_Split_2Click(Sender: TObject);
begin
...
procedure TForm1.TimerSpheresTimer(Sender: TObject);
begin
  formpaint(Sender);
